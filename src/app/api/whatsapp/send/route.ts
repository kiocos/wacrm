...
export async function POST(request: Request) {
  try {
    ...
    // The sender's display name — the send core prefixes outbound text
    // with it (*[Name]:*) so customers can tell which teammate is
    // replying on the shared number. Best-effort: a missing profile or
    // blank name just sends unprefixed.
